          ...
          <div class="card mb-4 new-profile-card">
            ...
            <div class="row m-4 p-3">
              ...
              <div class="col text-end">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill pencil-edit" viewBox="0 0 16 16" @click="editProfile">
              ...
              <div class="col-8 text-start">
                <div class="row">
                  <div class="col-12">
                    ...
                    <span class="text-muted">{{ userAddInfo.phoneNo }}</span>
                  </div>
                  <div class="col-12">
                    ...
                    <span class="text-muted">{{ userAddInfo.telegramHandle }}</span>
                  </div>
                  <div class="col-12">
