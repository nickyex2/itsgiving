        ...
        <div class="container">
            ...
            <div class="row" v-if="gridLayout">
                <div class="col-6 searchbar">
                    <input type="text" v-model="search"  placeholder="Got a Specific Project In Mind?" ref=""/>
                </div>
                <div class="col-5"></div>
                <div class="col-1">
                    <button class="btn rounded-circle float-right" @click="gridLayout = !gridLayout">
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-3" v-if="gridLayout">
                    ...
                    <div class="col">
                        <div class="card shadow-sm zoom">
                            ...
                            <div class="card-body px-3">
                                ...
                                <span class="d-flex justify-content-left pb-3"><span class="badge text-uppercase">{{
                                csp.cat }}</span></span>
